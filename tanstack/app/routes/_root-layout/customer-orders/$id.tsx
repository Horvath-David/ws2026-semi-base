...
import { LuFilter, LuInfo } from "react-icons/lu";
import { API_URL } from "../../../constants";

export const Route = createFileRoute("/_root-layout/customer-orders/$id")({
    ...
    <div className="px-8 py-12">
      ...
      <div className="flex gap-4 items-center justify-center mt-8">
        ...
        <span>
          ...
          {Math.ceil((data?.totalCount ?? 0) / searchData.pageSize) || 1}
        </span>
        <Button
          isIconOnly
          size="sm"
